<form method="post" action="">
  ...
  <div class="mb-3">
    ...
    <input type="date" value="<?php echo $foto -> Fecha ?>" name="fecha" class="form-control" id="input1" aria-describedby="InputHelp">
    <div id="emailHelp" class="form-text">Ingrese el nombre de la foto.</div>
  </div>
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <div class="mb-3">
      <select name="album" class="form-select" aria-label="Default select example">
        <option value="0" selected>Escoga el album: <?php echo $foto -> IdAlbum ?></option>
